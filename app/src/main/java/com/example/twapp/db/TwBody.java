...
public class TwBody {
    ...
    public TwBody(String peopleNun, String pName, String paAge, String pGender,
                  String pBedNumber, String RunningNumber, String firstTime, int passId, String isLowBattery,
                  List<String> Temperatures, List<String> TwTime, List<Long> TwTimeLong) {
    ...
    public List<Long> getTwTimeLong() {
        return this.TwTimeLong;
    }


    public void setTwTimeLong(List<Long> TwTimeLong) {
        this.TwTimeLong = TwTimeLong;
    }
